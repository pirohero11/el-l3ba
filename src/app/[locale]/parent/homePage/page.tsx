    ...
    return (
        <div className='flex flex-col items-center h-full w-full gap-10 max-w-screen'>
            ...
            <main className='w-[90%] h-full flex flex-col items-center gap-10 mb-7'>
                <p className='text-center font-black text-xl text-bright-purple'>Chris has something for you to see</p>
                <div className='w-full h-100 bg-white border-bright-purple py-5 border-4 rounded-3xl flex flex-col items-center gap-7'>
                    <div>
                        <p className='text-center font-black text-lg text-black'>Clean the room</p>
                        <p className='text-center font-black text-[15px] text-black/40'>Submitted today at 4 PM</p>
                    </div>
