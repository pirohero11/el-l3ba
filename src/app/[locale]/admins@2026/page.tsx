...
export default async function AdminPage({ params }: { params: Promise<{ locale: string }> }) {
    ...
    return (
        <div className='flex flex-col items-center h-full w-full justify-center max-w-screen p-6 min-h-screen bg-slate-50'>
            <div className='flex flex-col items-center justify-center gap-6 text-center max-w-md bg-white p-8 rounded-3xl border border-slate-200 shadow-md'>
                ...
                <div className="flex flex-col gap-1">
                    <h1 className='font-black text-3xl text-bright-purple'>Admin Portal</h1>
                    <p className="text-slate-500 text-sm font-medium">Protected by Biometric Security Guard</p>
                </div>
                <Link
