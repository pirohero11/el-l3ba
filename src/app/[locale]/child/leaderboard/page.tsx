...
export default async function HomePage({
  ...
  return (
    <div className="min-h-screen w-screen bg-background flex flex-col items-center p-4 pb-36">
      ...
      <div className="flex items-end justify-center gap-3 p-8 bg-slate-100 rounded-2xl">
      ...
      <div className="flex flex-col gap-6">
        <div className="w-90 h-18 rounded-4xl bg-white p-4 gap-4 flex items-center border-bright-purple truncate shadow-[0_8px_0_#7209B7]">
          <div className="w-10 h-10 rounded-full border-2 border-admin-slate/25 bg-admin-slate/15 flex items-center justify-center text-3xl text-admin-slate">4</div>
          <div className="w-20 h-10 text-white flex items-center gap-4 mr-30">
        ...
        <div className="w-90 h-18 rounded-4xl bg-white p-4 gap-4 flex items-center border-bright-purple truncate shadow-[0_8px_0_#7209B7]">
          <div className="w-10 h-10 rounded-full border-2 border-admin-slate/25 bg-admin-slate/15 flex items-center justify-center text-3xl text-admin-slate">5</div>
          <div className="w-20 h-10 text-white flex items-center gap-4 mr-30">
            <img src="/avtr4.png" alt="" className="w-14 h-14 rounded-full bg-white border border-black" />
            <p className="text-bright-purple font-black text-2xl">Mark</p>
          </div>
        ...
        <div className="w-90 h-18 rounded-4xl bg-white p-4 gap-4 flex items-center border-bright-purple truncate shadow-[0_8px_0_#7209B7]">
          <div className="w-10 h-10 rounded-full border-2 border-admin-slate/25 bg-admin-slate/15 flex items-center justify-center text-3xl text-admin-slate">6</div>
          <div className="w-20 h-10 text-white flex items-center gap-4 mr-30">
            <img src="/avtr4.png" alt="" className="w-14 h-14 rounded-full bg-white border border-black" />
            <p className="text-bright-purple font-black text-2xl">Mark</p>
          </div>
        ...
        <div className="w-90 h-18 rounded-4xl bg-white p-4 gap-4 flex items-center border-bright-purple truncate shadow-[0_8px_0_#7209B7]">
          <div className="w-10 h-10 rounded-full border-2 border-admin-slate/25 bg-admin-slate/15 flex items-center justify-center text-3xl text-admin-slate">7</div>
          <div className="w-20 h-10 text-white flex items-center gap-4 mr-30">
            <img src="/avtr4.png" alt="" className="w-14 h-14 rounded-full bg-white border border-black" />
            <p className="text-bright-purple font-black text-2xl">Mark</p>
          </div>
        ...
        <div className="w-90 h-18 rounded-4xl bg-white p-4 gap-4 flex items-center border-bright-purple truncate shadow-[0_8px_0_#7209B7]">
          <div className="w-10 h-10 rounded-full border-2 border-admin-slate/25 bg-admin-slate/15 flex items-center justify-center text-3xl text-admin-slate">8</div>
          <div className="w-20 h-10 text-white flex items-center gap-4 mr-30">
            <img src="/avtr4.png" alt="" className="w-14 h-14 rounded-full bg-white border border-black" />
            <p className="text-bright-purple font-black text-2xl">Mark</p>
          </div>
        ...
        <div className="w-90 h-18 rounded-4xl bg-white p-4 gap-4 flex items-center border-bright-purple truncate shadow-[0_8px_0_#7209B7]">
          <div className="w-10 h-10 rounded-full border-2 border-admin-slate/25 bg-admin-slate/15 flex items-center justify-center text-3xl text-admin-slate">9</div>
          <div className="w-20 h-10 text-white flex items-center gap-4 mr-30">
            <img src="/avtr4.png" alt="" className="w-14 h-14 rounded-full bg-white border border-black" />
            <p className="text-bright-purple font-black text-2xl">Mark</p>
          </div>
        ...
        <div className="w-90 h-18 rounded-4xl bg-white p-4 gap-4 flex items-center border-bright-purple truncate shadow-[0_8px_0_#7209B7]">
          <div className="w-10 h-10 rounded-full border-2 border-admin-slate/25 bg-admin-slate/15 flex items-center justify-center text-3xl text-admin-slate">10</div>
          <div className="w-20 h-10 text-white flex items-center gap-4 mr-30">
            <img src="/avtr4.png" alt="" className="w-14 h-14 rounded-full bg-white border border-black" />
            <p className="text-bright-purple font-black text-2xl">Mark</p>
          </div>
