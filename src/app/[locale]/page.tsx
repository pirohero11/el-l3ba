...
export default async function Home({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <div className="flex flex-col gap-8 p-5 items-center max-h-screen">
      {/* header */}
      ...
      <div className="relative w-8/10 aspect-square float-animation ">
        ...
        <div className="relative w-full h-full bg-white rounded-[40px] border-4 border-white shadow-card overflow-hidden flex items-center justify-center p-6 bg-linear-to-br from-sky-blue to-bright-purple">
          <img
            ...
            src="/hero-logo.png"
          />
          <h1 className="absolute text-5xl sm:text-4xl md:text-5xl font-black text-white drop-shadow-[0_4px_4px_rgba(114,9,183,0.8)] text-center leading-tight">
            {t("logo")}
          </h1>
        </div>
      </div>
